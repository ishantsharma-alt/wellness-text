...
<body>
  ...
  <main>
    ...
    <section class="section gallery-section">
      <div class="container">
        ...
        <div class="gallery8_component">
          ...
          <div class="gallery-item"><img src="img/gallery-img-1.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-2.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-3.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-4.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-5.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-6.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-7.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-8.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-9.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-10.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-11.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-12.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-13.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-14.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-15.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-16.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
          <div class="gallery-item"><img src="img/gallery-img-17.webp" alt="Gallery Image"><div class="gallery-item-zoom"><i class="red-red fa-solid fa-search"></i></div></div>
    ...
    <div class="lightbox" id="lightbox" role="dialog" aria-modal="true" aria-label="Image viewer">
      <button class="lightbox-close" id="lightboxClose" aria-label="Close"><i class="red-red fa-solid fa-times"></i></button>
