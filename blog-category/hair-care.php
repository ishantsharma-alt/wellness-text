...
$meta_desc  = "Read all Hair Care posts from Paris Wellness Institute.";
$root = '../';
include '../header.php';
$posts = [
  ['slug'=>'hair-treatments','title'=>'Hair Treatments','cat'=>'Hair Care','date'=>'March 10, 2026','read'=>'5 min','excerpt'=>'Healthy, strong hair begins at the scalp. Our specialized treatments address hair thinning, hair loss, and dandruff by revitalizing your scalp and encouraging regrowth.','img'=>'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=600&h=440&fit=crop'],
];
?>
      ...
      <aside class="blog-sidebar">
        ...
        <div class="sw"><h3>Categories</h3>
          <ul class="sw-cats">
            ...
            <li><a href="hair-care.php" class="active-cat" title="Read Hair Care Articles">Hair Care <span class="cat-pill">1</span></a></li>
