<?php
$cat_name = "Body Wellness";
$cat_slug = "body-wellness";
$page_title = "$cat_name | Paris Wellness Institute Blog";
$meta_desc  = "Read all Body Wellness posts from Paris Wellness Institute.";
$root = '../';
include '../header.php';
$posts = [
  ['slug'=>'body-treatments','title'=>'Body Treatments','cat'=>'Body Wellness','date'=>'March 10, 2026','read'=>'5 min','excerpt'=>'Wellness goes beyond the surface. Our body services include toning, slimming, detoxifying, and recovery therapies designed to make you feel lighter, stronger, and more energized.','img'=>'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=440&fit=crop'],
];
?>
    ...
    <div class="blog-layout">
      ...
      <aside class="blog-sidebar">
        ...
        <div class="sw"><h3>Categories</h3>
          <ul class="sw-cats">
            <li><a href="skin-care.php" title="Read Skin Care Articles">Skin Care <span class="cat-pill">1</span></a></li>
            <li><a href="hair-care.php" title="Read Hair Care Articles">Hair Care <span class="cat-pill">1</span></a></li>
            <li><a href="body-wellness.php" class="active-cat" title="Read Body Wellness Articles">Body Wellness <span class="cat-pill">1</span></a></li>
          </ul>
        </div>
