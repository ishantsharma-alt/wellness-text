  ...
  <main id="main-content">
    ...
    <nav class="gwi-filter-bar" id="gwi-filter-bar" aria-label="Treatment categories">
      <div class="gwi-filter-inner">
        ...
        <button class="gwi-filter-btn" onclick="gwiFilter(this,'face')"><i class="red-red fa-solid fa-star"></i> Face &amp; Skin</button>
        <div class="gwi-filter-sep"></div>
        <button class="gwi-filter-btn" onclick="gwiFilter(this,'body')"><i class="red-red fa-solid fa-star"></i> Body &amp; Contouring</button>
        <div class="gwi-filter-sep"></div>
        <button class="gwi-filter-btn" onclick="gwiFilter(this,'hair')"><i class="red-red fa-solid fa-star"></i> Hair &amp; Scalp</button>
      </div>
    </nav>
      ...
      <div class="gwi-container">
        ...
        <div class="gwi-cat-block gwi-visible" id="gwi-block-face">
          <div class="gwi-cat-head">
            <div class="gwi-cat-icon"><i class="red-red fa-solid fa-sparkles"></i></div>
        ...
        <div class="gwi-cat-block gwi-visible" id="gwi-block-body">
          <div class="gwi-cat-head">
            <div class="gwi-cat-icon"><i class="red-red fa-solid fa-gem"></i></div>
        ...
        <div class="gwi-cat-block gwi-visible" id="gwi-block-hair">
          <div class="gwi-cat-head">
            <div class="gwi-cat-icon"><i class="red-red fa-solid fa-leaf"></i></div>
    ...
    <div class="gwi-modal-overlay" id="gwi-modal-overlay"
      ...
      <div class="gwi-modal" id="gwi-modal">
        ...
        <button class="gwi-modal-close"
                ...
                aria-label="Close"><i class="red-red fa-solid fa-times"></i></button>
      ...
      <div class="container">
        ...
        <div class="advantages-grid">
          <div class="advantage-item" data-aos="fade-up">
            <div class="advantage-icon"><i class="red-red fa-solid fa-bullseye"></i></div>
          ...
          <div class="advantage-item" data-aos="fade-up" data-aos-delay="100">
            <div class="advantage-icon"><i class="red-red fa-solid fa-cog"></i></div>
