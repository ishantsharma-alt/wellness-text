    ...
    <section class="error-section container">
      <div class="error-content">
        ...
        <div class="error-suggestions">
          <h3>Helpful Links</h3>
          <ul>
            <li><a href="index.php"><i class="red-red fa-solid fa-home"></i> Home</a></li>
            <li><a href="about-us.php"><i class="red-red fa-solid fa-info-circle"></i> About Us</a></li>
            <li><a href="treatments.php"><i class="red-red fa-solid fa-pills"></i> Treatments</a></li>
            <li><a href="gallery.php"><i class="red-red fa-solid fa-image"></i> Gallery</a></li>
            <li><a href="testimonials.php"><i class="red-red fa-solid fa-star"></i> Testimonials</a></li>
            <li><a href="blog.php"><i class="red-red fa-solid fa-pen-nib"></i> Blog</a></li>
            <li><a href="contact-us.php"><i class="red-red fa-solid fa-phone"></i> Contact</a></li>
          </ul>
        </div>
      </div>
